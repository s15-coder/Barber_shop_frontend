...
// EXTERNAL MODULE: ./src/css/background.css
var background = __webpack_require__(8);

// CONCATENATED MODULE: ./src/js/utils/utils.js
var isMobile=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
// CONCATENATED MODULE: ./src/js/pages/index.js
isMobile?(window.location.replace("./html/login_movil.html"),console.log("IsMobile")):(window.location.replace("./html/login_desktop.html"),console.log("isDesktop"));
